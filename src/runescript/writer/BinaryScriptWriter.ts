...
import { Block } from '#/compiler/codegen/script/Block.js';
import { Label } from '#/compiler/codegen/script/Label.js';
import { RuneScript } from '#/compiler/codegen/script/RuneScript.js';
import { SwitchTable } from '#/compiler/codegen/script/SwitchTable.js';

import { ScriptSymbol } from '#/compiler/symbol/ScriptSymbol.js';
import { BasicSymbol, LocalVariableSymbol, RuneScriptSymbol } from '#/compiler/symbol/Symbol.js';
...
import { BaseScriptWriter, IdProvider } from '#/compiler/writer/BaseScriptWriter.js';

import { ServerScriptOpcode } from '#/runescript/ServerScriptOpcode.js';

import { ScriptVarType } from '#/runescript/type/ScriptVarType.js';

import { BinaryScriptWriterContext } from '#/runescript/writer/BinaryScriptWriterContext.js';
