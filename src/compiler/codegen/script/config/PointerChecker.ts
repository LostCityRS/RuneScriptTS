...
import { Instruction } from '#/compiler/codegen/Instruction.js';

import { RuneScript } from '#/compiler/codegen/script/RuneScript.js';

import { GraphGenerator } from '#/compiler/codegen/script/config/GraphGenerator.js';
import { InstructionNode } from '#/compiler/codegen/script/config/InstructionNode.js';
import { PointerInstructionNode } from '#/compiler/codegen/script/config/PointerInstructionNode.js';

import { Diagnostic } from '#/compiler/diagnostics/Diagnostic.js';
...
import { BasicSymbol, LocalVariableSymbol } from '#/compiler/symbol/Symbol.js';
...
import { VarBitType, VarNpcType, VarPlayerType } from '#/compiler/type/wrapped/GameVarType.js';
