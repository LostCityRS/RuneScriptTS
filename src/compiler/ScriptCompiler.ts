...
import { CodeGenerator } from '#/compiler/codegen/CodeGenerator.js';
...
import { BaseDiagnosticsHandler, DiagnosticsHandler } from '#/compiler/diagnostics/DiagnosticsHandler.js';

import { PointerHolder } from '#/compiler/pointer/PointerHolder.js';

import { MacroProcessor, MacroRegistry, MacroExpansionSpan } from '#/compiler/preprocess/MacroProcessor.js';

import { StrictFeatureLevel } from '#/compiler/StrictFeatureLevel.js';

import { ScriptRegistration } from '#/compiler/semantics/ScriptRegistration.js';
...
import type { Type } from '#/compiler/type/Type.js';
