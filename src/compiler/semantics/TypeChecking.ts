...
import { ParserErrorListener } from '#/compiler/ParserErrorListener.js';
...
import { DiagnosticMessage } from '#/compiler/diagnostics/DiagnosticMessage.js';
import { Diagnostics } from '#/compiler/diagnostics/Diagnostics.js';

import { ClientScriptSymbol, ScriptSymbol } from '#/compiler/symbol/ScriptSymbol.js';
import { BasicSymbol, ConstantSymbol, LocalVariableSymbol, RuneScriptSymbol } from '#/compiler/symbol/Symbol.js';
...
import { TypeManager } from '#/compiler/type/TypeManager.js';

import { ArrayType } from '#/compiler/type/wrapped/ArrayType.js';
import { GameVarType } from '#/compiler/type/wrapped/GameVarType.js';
...
import { ExpressionStringPart, StringPart } from '#/parser/ast/expr/StringPart.js';
...
import { ScriptParser } from '#/parser/parser/ScriptParser.js';
import { AstBuilder } from '#/parser/parser/AstBuilder.js';
